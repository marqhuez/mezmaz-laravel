                ...
                <div class="flex flex-col items-center mb-5">
                    ...
                    <table class="w-1/2">
                        ...
                        <tr>
                            ...
                            <td>{{ $orderInfo->isBio ? 'Igen' : 'Nem' }}</td>
                        </tr>
                    </table>
                </div>
                <div class="flex justify-center mb-5">
                    <div class="w-2/5 flex flex-col mr-5">
                        <h2 class="font-bold mb-5 ml-1 text-center">Számlázási adatok</h2>
                        <table>
                            <tr>
                                <td class="font-bold">Vezetéknév:</td>
                                <td>{{ $customer->billingAddress->lastName }}</td>
                            </tr>
                            <tr>
                                <td class="font-bold">Keresztnév:</td>
                                <td>{{ $customer->billingAddress->firstName }}</td>
                            </tr>
                            <tr>
                                <td class="font-bold">Megye:</td>
                                <td>{{ $customer->billingAddress->county }}</td>
                            </tr>
                            <tr>
                    ...
                    <div class="w-2/5 flex flex-col ml-5">
                        <h2 class="font-bold mb-5 ml-1 text-center">Szállítási adatok</h2>
                        <table>
                            <tr>
                                <td class="font-bold">Vezetéknév:</td>
                                <td>{{ $customer->deliveryAddress->lastName }}</td>
                            </tr>
                            <tr>
                                <td class="font-bold">Keresztnév:</td>
                                <td>{{ $customer->deliveryAddress->firstName }}</td>
                            </tr>
                            <tr>
                                <td class="font-bold">Megye:</td>
                                <td>{{ $customer->deliveryAddress->county }}</td>
                            </tr>
                            <tr>
                                <td class="font-bold">Irányítószám:</td>
                                <td>{{ $customer->deliveryAddress->postCode }}</td>
                            </tr>
                            <tr>
                                <td class="font-bold">Város:</td>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <table class="w-4/5">
                        @foreach ($orderInfo->orderItems as $orderItem)
                            <tr>
                                <td><span class="font-bold">Méret:</span> {{ $orderItem->combSize }}</td>
                                <td><span class="font-bold">Mennyiség:</span> {{ $orderItem->combAmount }} kg</td>
                                <td><span class="font-bold">Típus:</span> {{ $orderItem->combType }}</td>
                                <td><span class="font-bold">Saját viasz mennyisége ehhez a tételhez:</span>
                                    {{ $orderItem->ownWaxAmount }} kg</td>
                            </tr>
                        @endforeach
                    </table>
                </div>
