...
<div class="flex justify-center">
    <div class="mr-5 flex items-center">
        <input name="sameDeliveryAndBilling" onchange="switchSameDeliveryAndBilling(this)"
            id="sameDeliveryAndBillingToggle" type="checkbox" class="toggle toggle-primary" checked="checked"
            autocomplete="off" />
        <label class="ml-2" for="sameDeliveryAndBillingToggle">Szállítási és számlázási cím megegyezik</label>
    </div>
    <div class="mr-5 flex items-center">
...
<div id="billing-address">
    ...
    <div class="inline-block w-full">
        <h3>Cím</h3>
        <input class="input w-full" type="text" name="billingAddress[address]" value="" required>
    </div>
</div>
<div class="hidden" id="delivery-address">
    ...
    <div class="inline-block w-full">
        <h3>Cím</h3>
        <input class="input w-full" type="text" name="deliveryAddress[address]" value="">
    </div>
</div>
