...
<div class="flex justify-center">
    <div class="mr-5 flex items-center">
        <input
            ...
            onchange="switchSameDeliveryAndBilling(this)"
            id="sameDeliveryAndBillingToggle"
            type="checkbox"
            class="toggle toggle-primary"
            checked="checked"
            autocomplete="off"
        />
        <label class="ml-2" for="sameDeliveryAndBillingToggle">
            Szállítási és számlázási cím megegyezik
        </label>
    </div>
    <div class="mr-5 flex items-center">
        <input
            name="deliveryForBillingAddress"
            id="deliveryForBillingAddress"
            type="checkbox"
            class="toggle toggle-primary"
            autocomplete="off"
        />
        <label class="ml-2" for="deliveryForBillingAddress">
            Számlázási címre kéri a szállítást
        </label>
    </div>
</div>
<hr class="mt-4 mb-3" />
