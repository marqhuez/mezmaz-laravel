                ...
                <div class="order-info-step">
                    <form action="/order/new/order-info/save" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="flex justify-center">
                                <div class="mr-5 flex items-center">
                                    <input
                                        name="hasOwnWax"
                                        onchange="ownWaxToggleListener(this)"
                                        id="hasOwnWaxToggle"
                                        type="checkbox"
                                        ...
                                        autocomplete="off"
                                    />
                                    <label class="ml-2" for="hasOwnWaxToggle">
                                        Saját viaszos rendelés
                                    </label>
                                </div>
                                <div class="mr-5 flex items-center">
                                    <input
                                        name="isBioOrder"
                                        onchange="bioToggleListener(this)"
                                        id="isBioOrderToggle"
                                        type="checkbox"
                                        class="toggle toggle-primary"
                                        autocomplete="off"
                                    />
                                    <label class="ml-2" for="isBioOrderToggle">
                                        Bio rendelés
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="flex justify-center text-7xl">
                            <button
                                type="button"
                                hx-get="/order/new/order-info/new-order-item"
                    ...
                    <script>
                        const handleOwnWaxToggle = (value) => {
                            const infoInputs = document.querySelectorAll(
                                '.order-info-input-container',
                            );
                            const waxInputs = document.querySelectorAll(
                                '.own-wax-input-container',
                            );
